...
<div class="container-fluid">
    <form action="" id="account-form">
        ...
        <div class="form-group">
            ...
            <input type="number" name="credit_limit" id="credit_limit" class="form-control form-control-border" placeholder="Enter Credit Limit" value ="<?php echo isset($credit_limit) ? $credit_limit : '' ?>" required>
        </div>

        <div class="form-group">
            <label for="outstanding_balance" class="control-label">Outstanding Balance</label>
            <input type="number" name="outstanding_balance" id="outstanding_balance" class="form-control form-control-border" placeholder="Enter Outstanding Balance" value ="<?php echo isset($outstanding_balance) ? $outstanding_balance : '' ?>" required>
        </div>
